                  ...
                  <div class="x_content">
                    ...
                    {{Form::model($patient, array('route' => array('wellnessPatientSave', $patient->id),'class' => 'form-horizontal form-label-left'))}}
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        {{Form::label('personal_id', 'ชื่อ-นามสกุล', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12'))}}
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        {{Form::label('birthday', 'เพศ', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12'))}}
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="birthday" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text" value="{{date('j/m/Y',strtotime($patient->birthdate))}}">
                        </div>
                      </div>
